...
//        holder.checkBox.setChecked(Maps.get(position));
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        //ImageView imageView;
        final TextView clothesNameText;
        final TextView clothesTypeText;
        ...
        MyHolder(View itemView) {
            ...
            clothesNameText = itemView.findViewById(R.id.clothesNameText);
            clothesTypeText = itemView.findViewById(R.id.clothesType);
            clothesImage = itemView.findViewById(R.id.clothesImage);
            //imageView=(ImageView) itemView.findViewById(R.id.clothesImage);
            checkBox = itemView.findViewById(R.id.checkboxChooseClothes);
        }
