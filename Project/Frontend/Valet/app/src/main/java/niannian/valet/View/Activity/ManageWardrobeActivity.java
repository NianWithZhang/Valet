...
public class ManageWardrobeActivity extends AppCompatActivity
    ...
    //衣橱名称长度最大值
    private final static int WARDROBE_NAME_LIMIT = 5;

    private RecyclerView wardrobeRecyclerView;

    private ArrayList<Integer> selectedIdList;
    private WardrobeRecyclerViewAdapter adapt;
    private WardrobeResponseList wardrobeList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wardrobeRecyclerView = findViewById(R.id.manageWardrobeRecyclerView);
        Toolbar toolbar = findViewById(R.id.manageWardrobeToolbar);
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowTitleEnabled(false);

        selectedIdList=new ArrayList<>();

        DrawerLayout drawer = findViewById(R.id.manageWardrobeDrawer_layout);
    ...
    private void initWardrobes(){
        ...
        call.enqueue(new Callback<WardrobeResponseList>() {
            ...
            public void onResponse(@NonNull retrofit2.Call<WardrobeResponseList> call, @NonNull Response<WardrobeResponseList> response) {
                ...
                if(Objects.requireNonNull(wardrobeList).wardrobes.length==0)
    ...
    private void initWardrobesManageWardrobe(){
        ...
        adapt.setItemClickListener(new WardrobeRecyclerViewAdapter.wardrobeRecyclerViewOnItemClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
                ...
                Objects.requireNonNull(ActivityOperationUtil.findActivity(view.getContext())).finish();
